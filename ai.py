...
def gen_tags(script):
    ...
    messages=[
        ...
        {"role": "user", "content": "Could you give me EXACTLY a 440 character list of tags relevant to this video (script) and perfect for SEO views? (I make videos of reddit posts with satisfying backgrounds and a voiceover of the comments). (Seperate each tag by a comma)\n\n" + script}  # <-- This is the user message for which the model will generate a response
    ]
    )
